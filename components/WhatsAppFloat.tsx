...
/** Botões flutuantes fixos (WhatsApp + Instagram) em todas as páginas. */
export default function WhatsAppFloat() {
  return (
    ...
    >
      {/* Instagram */}
      <a
        href={site.empresa.instagram}
        target="_blank"
        rel="noopener noreferrer"
        aria-label={`Instagram da ${site.empresa.nome}`}
        style={{
          width: 52,
          height: 52,
          borderRadius: "50%",
          ...
          boxShadow: "0 6px 20px rgba(214, 36, 159, 0.38)",
        }}
      >
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" aria-hidden="true">
